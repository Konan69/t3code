...
import Migration0044 from "./Migrations/044_ProjectionMachineBindings.ts";
import Migration0045 from "./Migrations/045_ProjectionMachineProjectWorkspaceRoot.ts";
...
export const migrationEntries = [
  ...
  [44, "ProjectionMachineBindings", Migration0044],
  [45, "ProjectionMachineProjectWorkspaceRoot", Migration0045],
] as const;
